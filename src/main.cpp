...
namespace modmainhooks {
    ...
    void (*onCreateEditLevelLayer)(gd::EditLevelLayer*, gd::GJGameLevel*);
    void (*onShowCollab)(gd::EditLevelLayer*);
    ...
    gd::EditLevelLayer* EditLevelLayer_create(gd::GJGameLevel* level) {
        ...
        onCreateEditLevelLayer(created_layer, level);
...
void mod_main(HMODULE) {
    modmainhooks::onCreateEditLevelLayer = modmain::onCreateEditLevelLayer;
    modmainhooks::onShowCollab = modmain::onShowCollab;
